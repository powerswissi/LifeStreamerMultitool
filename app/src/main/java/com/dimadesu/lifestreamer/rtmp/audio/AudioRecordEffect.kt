...
/**
 * Audio effect interface (app-local copy).
 */
class AudioRecordEffect {
    interface IFactory {
    ...
    abstract class Factory<T : AudioEffect> : IFactory {
    ...
    class AcousticEchoCancelerFactory : Factory<AcousticEchoCanceler>() {
    ...
    class AutomaticGainControlFactory : Factory<AutomaticGainControl>() {
    ...
    class NoiseSuppressorFactory : Factory<NoiseSuppressor>() {
